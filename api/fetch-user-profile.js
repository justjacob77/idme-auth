...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    jwt.verify(
      ...
      getKey,
      {
        algorithms: ['RS256'], // Ensure RS256 algorithm
        issuer: 'https://api.id.me/oidc', // Validate the issuer
        audience: '28bf5c72de76f94a5fb1d9454e347d4e', // Replace with your Client ID
      },
      (err, decoded) => {
        if (err) {
